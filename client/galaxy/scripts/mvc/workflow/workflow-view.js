...
export default Backbone.View.extend({
    ...
    prebuildNode: function(type, title_text, content_id) {
        ...
        let enableToolRecommendations = window.Galaxy.config.enable_tool_recommendations;
        if (node.content_id !== undefined && (enableToolRecommendations === true || enableToolRecommendations === 'true')) {
